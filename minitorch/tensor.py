...
class Tensor:
    ...
    def zeros(self, shape: Optional[UserShape] = None) -> Tensor:
        """Create a tensor filled with zeros with the specified shape.

        Args:
        ----
            shape: The shape of the tensor to create. If None, a scalar tensor is created.
    ...
    def parents(self) -> Iterable[Variable]:
        """Return the parent variables of the tensor."""
    ...
    def __radd__(self, a: TensorLike) -> Tensor:
        """Add two tensors (reversed)."""
        return self + a

    def __rmul__(self, a: TensorLike) -> Tensor:
        """Multiply two tensors (reversed)."""
        return self * a
